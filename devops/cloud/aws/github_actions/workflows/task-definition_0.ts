module.exports = {
    ...
    "containerDefinitions": [
        {
            "name": "onedata-2945",
            "image": `${process.env.AWS_ACCOUNT_ID}.dkr.ecr.us-east-1.amazonaws.com/geppetto-generatedcode-angulartest-2945-onedata:latest`,
        ...
        {
            "name": "twodata-2945",
            "image": `${process.env.AWS_ACCOUNT_ID}.dkr.ecr.us-east-1.amazonaws.com/geppetto-generatedcode-angulartest-2945-twodata:latest`,
            "memoryReservation": "300",
            "resourceRequirements": null,
            "essential": true,
            "portMappings": [
