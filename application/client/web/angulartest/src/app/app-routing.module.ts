...
{ path : 'createone', loadChildren: () => import('./createone/createone.module').then(m => m.CreateoneModule), canActivate: [AuthGuard] } , 
{ path : 'createtwo', loadChildren: () => import('./createtwo/createtwo.module').then(m => m.CreatetwoModule), canActivate: [AuthGuard] } , 
];
